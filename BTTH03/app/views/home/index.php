...
<body>
    <div class="container">
        <nav class="navbar navbar-expand-lg bg-body-tertiary mt-0">
            <div class="container-fluid" style="background-color:aliceblue;">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link active fw-bold" style="color: blue; font-size: 30px" aria-current="page" href="<?= DOMAIN . '/public/index.php'?>">Bệnh nhân</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link fw-bold " style="font-size: 30px" href="<?= DOMAIN . '/public/index.php'?>">Bác sĩ</a>
                    </li>
                </ul>
        ...
        <a href="<?= DOMAIN . '/app/views/patient/add.php' ?>" class='btn btn-success'> Thêm bệnh nhân</a>
        <table class="table">
            <thead>
                <tr>
